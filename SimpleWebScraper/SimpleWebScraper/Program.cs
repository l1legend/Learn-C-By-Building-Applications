...
namespace SimpleWebScraper
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                Console.WriteLine("Please enter city you would like to scrape information from:");
                ...
                using (WebClient client = new WebClient())
                {
                    ...
                    string content = client.DownloadString($"https://{craigslistCity.Replace(" ", string.Empty)}.craigslist.org/d/cars-trucks/{Method}/{craigslistCategoryName}");
